    ...
    >
      <PageContainer>
        <motion.div 
          ...
          className={`border transition-all px-4 py-3 sm:px-5 ${isMenuOpen ? "rounded-sm bg-white" : "rounded-sm bg-white"}`}
        >
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <button
                id="navbar-home-logo"
                type="button"
                className="flex items-center gap-3 text-[1.15rem] font-bold font-grotesk tracking-tight text-black transition-all hover:opacity-90 focus-visible:outline-none rounded-sm group"
                onClick={() => handleNavigation("home", "overview")}
              >
                <span className="grid place-items-center w-8 h-8 rounded-sm bg-black/5 text-black border border-black transition-colors duration-300 group-hover:bg-black/10">
                ...
                <span className="flex items-center hidden sm:flex">Audit<span className="text-black/40 ml-0.5 opacity-90 transition-colors group-hover:text-black/90">Sys</span></span>
              </button>
            ...
            <div className="hidden items-center gap-1.5 lg:flex">
              ...
              <button
                ...
                className="text-sm font-semibold text-black transition-all duration-200 ease-out px-3 py-2 rounded-sm border border-transparent hover:border-black hover:bg-black hover:text-white hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:shadow-none translate-y-0 hover:translate-y-[2px] hover:translate-x-[2px]"
              >
            ...
            <div className="flex items-center gap-2 lg:hidden">
              ...
              <button
                type="button"
                className="inline-flex h-10 w-10 items-center justify-center rounded-sm border border-black bg-white text-black transition-colors duration-200 ease-out hover:bg-black hover:text-white focus-visible:ring-2 focus-visible:ring-black shadow-[2px_2px_0_rgba(0,0,0,1)] hover:shadow-none translate-y-0 hover:translate-y-[2px] hover:translate-x-[2px]"
          ...
          <AnimatePresence>
            {isMenuOpen && (
              ...
              >
                <div className="mt-4 space-y-1.5 border-t border-black pt-4 pb-2">
                  {navigationItems.map((item) => (
                    <button
                      ...
                      className={[
                        ...
                        isActiveItem(item) ? "bg-black text-white border border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]" : "text-black hover:bg-black hover:text-white border border-transparent",
                      ]
                        .filter(Boolean)
                        .join(" ")}
                  ...
                  <button
                    type="button"
                    className="flex w-full items-center h-12 rounded-sm px-5 text-left text-sm font-semibold transition-all duration-200 ease-out text-black hover:bg-black hover:text-white border border-transparent active:scale-[0.98]"
                    onClick={hasToken ? () => handleNavigation(dashboardRoute) : handleAuthAction}
                  >
                    {hasToken ? dashboardLabel : "Login"}
                  </button>
