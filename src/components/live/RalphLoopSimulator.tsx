      ...
      <div className="grid gap-6 lg:grid-cols-12">
        ...
        <div className="lg:col-span-4 rounded-sm border border-black/5 bg-white p-5 flex flex-col justify-between">
          <div className="space-y-4">
            ...
            <div className="space-y-4 relative pl-8 border-l border-black mt-2">
              ...
              <div className="relative">
                ...
                <div>
                  <h4 className={`text-xs font-semibold ${currentStep.includes("edit") && currentStep.startsWith("round1") ? "text-violet-300 font-bold animate-pulse" : "text-black/80"}`}>
              ...
              <div className="relative">
                ...
                <div>
                  <h4 className={`text-xs font-semibold ${currentStep === "round3_pass" ? "text-emerald-300 font-bold animate-pulse" : "text-black/80"}`}>
              ...
              <div className="relative">
                ...
                <div>
                  <h4 className={`text-xs font-semibold ${currentStep === "completed" ? "text-emerald-300 font-bold" : "text-black/80"}`}>
          ...
          <div className="mt-6 border-t border-black/5 pt-4">
            <span className="text-[10px] uppercase font-mono tracking-wider text-black/40 block mb-2">
              {isZh ? "Ralph 智慧防雷效益" : "Ralph Safeguard Efficiency"}
            </span>
            <div className="grid grid-cols-2 gap-3 text-center">
              <div className="rounded-sm border border-black/5 bg-black/5 p-2.5">
                <p className="text-xl font-bold font-mono text-violet-300">
                  {currentStep === "completed" ? "2" : isRunning ? "1" : "0"}
                </p>
                <p className="text-[9px] uppercase font-semibold text-black/40 mt-1">{isZh ? "阻隔迴圈次數" : "Loops Intercepted"}</p>
              </div>
              <div className="rounded-sm border border-black/5 bg-black/5 p-2.5">
                <p className="text-xl font-bold font-mono text-emerald-400">
                  {currentStep === "completed" ? "100%" : isRunning ? "95%" : "0%"}
                </p>
                <p className="text-[9px] uppercase font-semibold text-black/40 mt-1">{isZh ? "編譯通過率" : "Build Success"}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-8 flex flex-col min-h-[350px] rounded-sm border border-black bg-white overflow-hidden relative">
              ...
              {activeTab === "editor" && (
                ...
                >
                  ...
                  {currentStep === "round1_edit" && (
                    <div className="p-3 bg-violet-950/20 rounded-sm border border-violet-500/10 text-violet-300 flex items-center gap-2 mt-3 animate-pulse">
                  ...
                  {currentStep === "round1_fail" && (
                    <div className="p-3 bg-rose-950/25 rounded-sm border border-rose-500/20 text-rose-300 flex items-start gap-2 mt-3">
                  ...
                  {currentStep === "round2_fail" && (
                    <div className="p-3 bg-amber-950/25 rounded-sm border border-amber-500/20 text-amber-300 flex items-start gap-2 mt-3">
                      <AlertTriangle className="h-4 w-4 shrink-0 mt-0.5" />
                      <div>
                  ...
                  {currentStep === "completed" && (
                    <div className="p-3 bg-emerald-950/25 rounded-sm border border-emerald-500/20 text-emerald-300 flex items-center gap-2 mt-3">
              ...
              {activeTab === "terminal" && (
                ...
                >
                  <div className="space-y-1.5 h-[230px] overflow-y-auto custom-scrollbar">
                    {logs.length === 0 ? (
                      <div className="text-black/30 italic text-center pt-10">{isZh ? "等待 Ralph 模擬器啟動..." : "Awaiting simulator trigger..."}</div>
                    ) : (
                      logs.map((log, idx) => {
                        let colorClass = "text-black/60";
                        ...
                        return (
                          <div key={idx} className="flex gap-2 leading-relaxed font-mono">
                            <span className="text-black/35 shrink-0 select-none">[{log.time}]</span>
                ...
                >
                  <div className="rounded-sm border border-black/5 bg-white p-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="rounded-sm border border-rose-500/20 bg-rose-500/5 p-3">
                  ...
                  <div className="rounded-sm border border-black/5 bg-white p-4">
                    ...
                    <div className="space-y-1 text-[11px]">
                      ...
                      <div className="flex justify-between">
                        <span className="text-black/60">✓ Handles incoming responsive custom styleProps styles</span>
                        <span className="text-emerald-400 font-semibold font-mono">PASS</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-black/60">✓ Validates correct image sizes and eager load markers</span>
                        <span className="text-emerald-400 font-semibold font-mono">PASS</span>
                      </div>
                    </div>
                  </div>
          ...
          <div className="flex items-center justify-between border-t border-black/5 bg-neutral-100/40 px-4 py-2 text-[10px] text-black/40">
